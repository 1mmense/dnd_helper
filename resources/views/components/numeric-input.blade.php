<div>
    <div class="flex items-center">
        ...
        <button
            ...
            "
            class="
                flex items-center justify-center w-10 h-10 rounded-l-full transition duration-200 text-white text-xl font-medium border-t border-b border-l border-white/30
                hover:bg-white/15
            "
        >
            &minus;
